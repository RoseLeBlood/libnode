...
namespace ASF.Node.Binary {
    ...
    [Serializable]
    public class ByteBinaryTreeNode : ValueBinaryTreeNode<byte> { public ByteBinaryTreeNode (string name, byte value) : base (name, value) { } }

    [Serializable]
    public class Int16BinaryTreeNode : ValueBinaryTreeNode<short> { public Int16BinaryTreeNode (string name, short value) : base (name, value) { } }

    [Serializable]
    public class Int32BinaryTreeNode : ValueBinaryTreeNode<int> { public Int32BinaryTreeNode (string name, int value) : base (name, value) { } }

    [Serializable]
    public class Int64BinaryTreeNode : ValueBinaryTreeNode<long> { public Int64BinaryTreeNode (string name, long value) : base (name, value) { } }

    [Serializable]
    public class SByteBinaryTreeNode : ValueBinaryTreeNode<sbyte> { public SByteBinaryTreeNode (string name, sbyte value) : base (name, value) { } }

    [Serializable]
    public class UInt16BinaryTreeNode : ValueBinaryTreeNode<ushort> { public UInt16BinaryTreeNode (string name, ushort value) : base (name, value) { } }

    [Serializable]
    public class UInt32BinaryTreeNode : ValueBinaryTreeNode<uint> { public UInt32BinaryTreeNode (string name, uint value) : base (name, value) { } }

    [Serializable]
    public class UInt64BinaryTreeNode : ValueBinaryTreeNode<ulong> { public UInt64BinaryTreeNode (string name, ulong value) : base (name, value) { } }

    [Serializable]
    public class DecimalBinaryTreeNode : ValueBinaryTreeNode<decimal> { public DecimalBinaryTreeNode (string name, decimal value) : base (name, value) { } }

    [Serializable]
    public class DoubleBinaryTreeNode : ValueBinaryTreeNode<double> { public DoubleBinaryTreeNode (string name, double value) : base (name, value) { } }

    [Serializable]
    public class SingleBinaryTreeNode : ValueBinaryTreeNode<float> { public SingleBinaryTreeNode (string name, float value) : base (name, value) { } }
}