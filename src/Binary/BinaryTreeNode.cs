...
namespace ASF.Node.Binary {
    ...
    public class BinaryTreeNode<T> : Node<T, BinaryTreeNode<T>>, IEnumerable<T>, IList<GenericTreeNodeEntry<T>> {
        ...
        public BinaryTreeNode (string name) : base (name, 3) // 0: root, 1: left, 2:right
        {

        }
        public BinaryTreeNode (string name, T data) : base (name, data, 3) { }
